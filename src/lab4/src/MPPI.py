...
class MPPIController(object):
  def __init__(self):
    ...
    print "Successfully loaded path of shape", self.path.shape

    print "Applying y-axis flip, and xy-offsets of x:", OFFSET_X * RESOLUTION, "and y:", OFFSET_Y * RESOLUTION
    self.path[:, 1] *= -1
    self.path[:, 0] += OFFSET_X * RESOLUTION
    self.path[:, 1] += OFFSET_Y * RESOLUTION
